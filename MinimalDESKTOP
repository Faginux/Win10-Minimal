...
# Secondary Author: Ali Robertson <ali@ali.id.au>
# Secondary Author Source: https://gist.github.com/alirobe/7f3b34ad89a159e6daa1/
# Tweaked Source: https://github.com/ChrisTitusTech/win10script
#
...
$tweaks = @(
  ...
  "CreateRestorePoint",
	...
	"InstallOscarProgs", #REQUIRED FOR OTHER PROGRAM INSTALLS!
	"InstallAMDChipset",
	"InstallSnappy",
	"Install7Zip",
	"InstallNotepadplusplus",
	"InstallGeforce-game-ready-driver",
	"InstallFlashplayerplugin",
	"InstallWinAero",
	"InstallJava",
	"Install1password",
	"InstallCCleaner",
	...
	"HideTaskbarSearch",			# "ShowTaskbarSearchIcon",
	...
	"EnableThumbsDB",				# "DisableThumbnailCache",
...
#########
# Recommended Oscar Programs
#########

Function InstallOscarProgs {
...
Function InstallAMDChipset {
	Write-Output "Installing AMD Chipset Driver"
	choco install amd-ryzen-chipset -y
}

Function InstallSnappy {
	Write-Output "Installing Snappy Driver Installer"
	choco install snappy-driver-installer -y
}

Function InstallGeforce-game-ready-driver {
	Write-Output "Installing Geforce Game Ready Driver"
	choco install geforce-game-ready-driver -y
}

Function InstallFlashplayerplugin {
	Write-Output "Installing Flash P0ayer Plugin"
	choco install flashplayerplugin -y
}

Function InstallWinAero {
...
Function InstallFoxitreader {
	Write-Output "Installing Foxitreader"
...
Function InstallMKVtoolnix{
	Write-Output "Installing MKVToolnix"
	choco install mkvtoolnix -y
}

Function InstallSsubtitleworkshop {
	Write-Output "Installing Ssubtitleworkshop"
...
Function InstallCinebench {
	Write-Output "Installing CineBench R20"
